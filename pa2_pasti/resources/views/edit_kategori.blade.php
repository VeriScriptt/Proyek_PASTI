        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="container-fluid">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="editProdukModalLabel">Edit Kategori</h5>
                ...
                <div class="card-body">
                    @if (isset($data))
                        <form id="formEditKategori" action="{{ route('update.Kategori', $data['id']) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label for="editNamaKategori">Nama Kategori</label>
                                <input type="text" class="form-control" id="editNamaKategori" name="nama_kategori" value="{{ $data['nama_kategori'] }}" required>
                            </div>
