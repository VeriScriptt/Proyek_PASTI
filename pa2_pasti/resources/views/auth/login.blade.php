                                ...
                                <div class="p-5">
                                    ...
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="form-group">
                                            <input id="username" type="text" class="form-control form-control-user @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}" required autocomplete="username" autofocus placeholder="{{ __('Username') }}">
                                            @error('username')
                                        ...
                                        <hr>
                                        <div class="text-center">
                                            <a href="{{ route('register.show') }}" class="small">{{ __('Register') }}</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
